...
src/%.o: ../src/%.cpp
	...
	g++ -std=c++0x -I/opt/instantclient_19_8/sdk/include -I/opt/rapidjson/include -O0 -g3 -pedantic -pedantic-errors -w -Wall -Wextra -c -fmessage-length=0 -fsanitize=address -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
