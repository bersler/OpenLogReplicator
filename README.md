...
3. autoreconf -f -i
4. ./configure CXXFLAGS='-g -O0 -fsanitize=address' --with-rapidjson=/opt/rapidjson --with-rdkafka=/opt/librdkafka --with-instantclient=/opt/instantclient_19_10 --with-protobuf=/opt/protobuf --with-zeromq=/usr
5. make
...
2. cd OpenLogReplicator
3. autoreconf -f -i
4. ./configure CXXFLAGS='-O3' --with-rapidjson=/opt/rapidjson --with-rdkafka=/opt/librdkafka --with-instantclient=/opt/instantclient_19_10 --with-protobuf=/opt/protobuf --with-zeromq=/usr
5. make
...
3. export LD_LIBRARY_PATH=/opt/instantclient_19_10:/opt/protobuf/lib:/opt/librdkafka/lib
