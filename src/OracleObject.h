...
namespace OpenLogReplicator {
    ...
    public:
        ...
        OracleObject(uint32_t objn, uint32_t objd, uint32_t depdendencies, uint32_t cluCols, uint32_t options, string owner, string objectName);
