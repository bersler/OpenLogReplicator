...
namespace OpenLogReplicator {
    ...
    protected:
        ...
        void updateRaw(std::string& val, uint64_t maxLength, typeCol column, const DbTable* table, uint64_t offset);
        void updateString(std::string& val, uint64_t maxLength, typeCol column, const DbTable* table, uint64_t offset);
