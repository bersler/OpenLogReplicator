/* Header for OutputBufferJsonTest class
...
#ifndef OUTPUTBUFFERJSONTEST_H_
#define OUTPUTBUFFERJSONTEST_H_

using namespace std;

namespace OpenLogReplicator {

    class OutputBufferJsonTest : public OutputBufferJson {
    public:
        OutputBufferJsonTest(uint64_t timestampFormat, uint64_t charFormat, uint64_t scnFormat, uint64_t unknownFormat, uint64_t showColumns);
        virtual ~OutputBufferJsonTest();
