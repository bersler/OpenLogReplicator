...
namespace OpenLogReplicator {
    OracleTable::OracleTable(typeObj newObj, typeDataObj newDataObj, typeUser newUser, typeCol newCluCols, typeOptions newOptions, std::string& newOwner,
                             std::string& newName) :
        obj(newObj),
        dataObj(newDataObj),
        user(newUser),
    ...
    void OracleTable::addLobPartition(typeObj obj) {
        lobPartitions.push_back(obj);
    }

    void OracleTable::addLobIndex(typeObj obj) {
