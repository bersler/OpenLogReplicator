...
namespace OpenLogReplicator {
    ...
    public:
        enum CONTEXT {CONTEXT_NONE, CONTEXT_CPU, CONTEXT_OS, CONTEXT_MUTEX, CONTEXT_WAIT, CONTEXT_SLEEP, CONTEXT_MEM, CONTEXT_TRAN, CONTEXT_CHKPT,
                CONTEXT_NUM};
        enum REASON {REASON_NONE,
                // MUTEX
