...
namespace OpenLogReplicator {
    ...
    public:
        ...
        static uint64_t read48Little(const uint8_t* buf);
        static uint64_t read48Big(const uint8_t* buf);
        ...
        static void write48Little(uint8_t* buf, uint64_t val);
        static void write48Big(uint8_t* buf, uint64_t val);
