...
namespace OpenLogReplicator {
    ...
    public:
        ...
        OracleAnalyzerOnlineASM(OutputBuffer* outputBuffer, uint64_t dumpRedoLog, uint64_t dumpRawData, const char* dumpPath,
                ...
                const char* passwdASM, const char* connectStringASM, bool standby);
