...
namespace OpenLogReplicatorOracle {
	...
	protected:
		...
		void appendTransactionChunk(TransactionChunk* tc, uint32_t objdId, typeuba uba, uint32_t dba, uint8_t slt,
	...
	public:
		...
		TransactionChunk* addTransactionChunk(TransactionChunk* tc, uint32_t objdId, typeuba uba, uint32_t dba, uint8_t slt,
				RedoLogRecord *redoLogRecord1, RedoLogRecord *redoLogRecord2);
		TransactionChunk* rollbackTransactionChunk(TransactionChunk* tc, typeuba &lastUba, uint32_t &lastDba, uint8_t &lastSlt);
