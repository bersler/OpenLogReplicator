...
BEGIN
    ...
    SELECT D.LOG_MODE, D.SUPPLEMENTAL_LOG_DATA_MIN, D.SUPPLEMENTAL_LOG_DATA_PK, D.SUPPLEMENTAL_LOG_DATA_ALL, TP.ENDIAN_FORMAT, D.CURRENT_SCN, D.ACTIVATION#, VER.BANNER, SYS_CONTEXT('USERENV','DB_NAME')
    INTO v_LOG_MODE, v_SUPPLEMENTAL_LOG_DATA_MIN, v_SUPPLEMENTAL_LOG_DATA_PK, v_SUPPLEMENTAL_LOG_DATA_ALL, v_ENDIAN_FORMAT, v_CURRENT_SCN, v_ACTIVATION#, v_BANNER, v_DB_NAME
