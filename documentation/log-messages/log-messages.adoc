...
Check if the file is not corrupted.
Refer to the documentation for more information about xref:../json/filter.adoc#skip-xid[XID format].
...
==== code 30011: "Invalid startup parameters: <message>"

Startup parameters are not valid for chosen mode of operation.
...
To achieve this behavior, the xref:../json/source.adoc#flags[flags] parameter should be set appropriately.
