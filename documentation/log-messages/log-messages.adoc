...
==== code 20008: "row ID incorrect, size: <number>"

Row ID is in incorrect format.
The size of the row ID is not correct.
...
==== code 50006: "field missing in vector, field: <number>/<number>, ctx: <number>, obj: <number>, dataobj: <number>, op: <code>, cc: <number>, suppCC: <number>, fieldSize: <number>, code: <number>"
...
==== code 50053: "too big redo log record, size: <number>"
