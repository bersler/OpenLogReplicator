...
Please consider recreating schema checkpoint files: stop replication, delete content of checkpoint folder, and restart to recreate the schema file.
...
==== code 60037, "incorrect DDL data, pos: <number>"
