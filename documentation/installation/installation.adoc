...
* Character sets: 138 supported (see xref:../user-manual/user-manual.adoc#supported-character-sets[user manual])
...
The easiest way to compile is via the GitHub Docker repository:
...
See the Docker build scripts for distribution-specific package and compilation options.
