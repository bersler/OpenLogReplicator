...
[NOTE]
====
Storing in CLOB format causes the data to be stored in the exact same format as it was inserted.
...
[IMPORTANT]
====
The feature is in an experimental state, meaning that it may not work correctly in all cases.
