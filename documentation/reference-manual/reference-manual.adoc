...
* `0x0000` -- Unix with nanoseconds stored as character with time zone after comma sign -- `"tms": "1651384800123456789,Europe/Warsaw"`.
* `0x0001` -- Unix with microseconds precision stored as character with time zone after comma sign -- `"tms": "1651384800123457,Europe/Warsaw"`.
* `0x0002` -- Unix with milliseconds precision stored as character with time zone after comma sign -- `"tms": "1651384800123,Europe/Warsaw"`.
* `0x0003` -- Unix with seconds precision stored as character with time zone after comma sign -- `"tms": "1651384800,Europe/Warsaw"`.
* `0x0004` -- _ISO-8601_ format stored as character with time zone after space sign-- `"tms": "2022-05-01 06:00:00.123456789 Europe/Warsaw"`.
