...
a|`source`
a|_list_ of <<source,sources>>, mandatory
a|The list should contain just one source element.

a|`target`
a|_list_ of <<target,targets>>, mandatory
a|The list should contain just one target element.

a|`version`
a|_text_, max length: 256, mandatory
...
a|`dump-path`
a|_text_, max length: 256, default value: `.`
...
a|`dump-raw-data`
a|_number_, min: 0, max: 1, default: 0
...
a|`dump-redo-log`
a|_number_, min: 0, max: 2, default: 0
...
a|`trace`
a|_number_, min: 0, max: 4, default: 2
...
a|`trace2`
a|_number_, min: 0, max: 131071, default: 0
