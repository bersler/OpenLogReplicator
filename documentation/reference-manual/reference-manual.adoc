...
_IMPORTANT:_ The value of this parameter must be greater than the maximum expeced LOB field size + 10%.
Setting too low might cause OpenLogReplicator to stop if it encouters too big field which would not fit fully in memory.
