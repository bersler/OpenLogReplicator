...
* `1` -- Unix with microsecond precision (possible data precission loss) -- `"tm": 1651384800123457`.

* `2` -- Unix with millisecond precision (possible data precission loss) -- `"tm": 1651384800123`.

* `3` -- Unix with second precision (possible data precission loss) -- `"tm": 1651384800`.

* `4` -- Unix with nanoseconds stored as a string -- `"tms": "1651384800123456789"`.

* `5` -- Unix with microsecond precision stored as a string (possible data precission loss) -- `"tms": "1651384800123457"`.

* `6` -- Unix with millisecond precision stored as a string (possible data precission loss) -- `"tms": "1651384800123"`.

* `7` -- Unix with second precision stored as a string (possible data precission loss) -- `"tms": "1651384800"`.
...
* `2` -- Unix with millisecond precision stored as a string with time zone after comma sign (possible data precission loss) -- `"tms": "1651384800123,Europe/Warsaw"`.

* `3` -- Unix with second precision stored as a string with time zone after comma sign (possible data precission §loss) -- `"tms": "1651384800,Europe/Warsaw"`.
...
_TIP:_ This target is useful for testing purposes, to verify if redo log parsing works correctly.
