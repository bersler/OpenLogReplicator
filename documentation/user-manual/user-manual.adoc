...
For most data structures, including disk buffers, output buffers and copy of the redo log vectors the program uses one big pool of memory, which is fully controlled by two parameters: `memory-min-mb` and `memory-max-mb`.
